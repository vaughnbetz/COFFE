...
def generate_full_lut(spice_file, lut_mask, use_tgate):
	...
	for i in range(1, 2**(lvl_curr-1)+1):
		...
		sram_cell_count = sram_cell_count + 4
	...
	for i in range(1, 2**(lvl_curr-1)+1):
		if use_tgate:
			spice_file.write("Xlvl3_"+str(i)+"_mux n_2_"+ str(sram_cell_count) + " n_2_" + str(sram_cell_count+1) + " n_c" + " n_c_b" + " n_3_" + str(i) + " n_vdd gnd simple_mux Wn=tgate_lut_L3_nmos Wp=tgate_lut_L3_nmos Rw='wire_lut_L3_res/2' Cw='wire_lut_L3_cap/2'\n")
		else:
	...
	for i in range(1, 2**(lvl_curr-1)+1):
		if use_tgate:
			spice_file.write("Xlvl4_"+str(i)+"_mux n_3_"+ str(sram_cell_count) + " n_3_" + str(sram_cell_count+1) + " n_d" + " n_d_b" + " n_4_" + str(i) + " n_vdd gnd simple_mux Wn=tgate_lut_L4_nmos Wp=tgate_lut_L4_nmos Rw='wire_lut_L4_res/2' Cw='wire_lut_L4_cap/2'\n")
		else:
			spice_file.write("Xlvl4_"+str(i)+"_mux n_3_"+ str(sram_cell_count) + " n_3_" + str(sram_cell_count+1) + " n_d" + " n_d_b" + " n_4_" + str(i) + " gnd simple_mux Wn=ptran_lut_L4_nmos Rw='wire_lut_L4_res/2' Cw='wire_lut_L4_cap/2'\n")
		sram_cell_count = sram_cell_count + 2		
	...
	for i in range(1, 2**(lvl_curr-1)+1):
		if use_tgate:
			spice_file.write("Xlvl5_"+str(i)+"_mux n_4_buff_"+ str(sram_cell_count) + " n_4_buff_" + str(sram_cell_count+1) + " n_e" + " n_e_b" + " n_5_" + str(i) + " n_vdd gnd simple_mux Wn=tgate_lut_L5_nmos Wp=tgate_lut_L5_nmos Rw='wire_lut_L5_res/2' Cw='wire_lut_L5_cap/2'\n")
		else:
			spice_file.write("Xlvl5_"+str(i)+"_mux n_4_buff_"+ str(sram_cell_count) + " n_4_buff_" + str(sram_cell_count+1) + " n_e" + " n_e_b" + " n_5_" + str(i) + " gnd simple_mux Wn=ptran_lut_L5_nmos Rw='wire_lut_L5_res/2' Cw='wire_lut_L5_cap/2'\n")
		sram_cell_count = sram_cell_count + 2			
	...
	for i in range(1, 2**(lvl_curr-1)+1):
		if use_tgate:
			spice_file.write("Xlvl6_"+str(i)+"_mux n_5_"+ str(sram_cell_count) + " n_5_" + str(sram_cell_count+1) + " n_f" + " n_f_b" + " n_6_" + str(i) + " n_vdd gnd simple_mux Wn=tgate_lut_L6_nmos Wp=tgate_lut_L6_nmos Rw='wire_lut_L6_res/2' Cw='wire_lut_L6_cap/2'\n")
		else:
	...
	for i in range(1, 2**(lvl_curr-1)+1):
		if use_tgate:
			spice_file.write("Xlut_buffer_"+str(i)+"_out n_6_"+ str(sram_cell_count) + " n_out n_vdd gnd " +  " lut_buffer inv_1_nmos=inv_lut_out_buffer_1_nmos inv_1_pmos=inv_lut_out_buffer_1_pmos Rw_int=wire_lut_out_buffer_res Cw_int=wire_lut_out_buffer_cap inv_2_nmos=inv_lut_out_buffer_2_nmos inv_2_pmos=inv_lut_out_buffer_2_pmos Rw_out=0 Cw_out=0 \n")
		else:
...
for d in drivers:
	...
	generate_spice_file(spice_file, input_vector, d, lut_mask, use_tgate)
	spice_file.close()
