...
def print_vpr_file_ib(vpr_file, fpga_inst):
	...
	vpr_file.write("      </interconnect>\n")
	vpr_file.write("    </mode>\n")
	vpr_file.write("    <fc in_type=\"frac\" in_val=\"0.15\" out_type=\"frac\" out_val=\"0.10\"/>\n")
	...
	vpr_file.write("    <input name=\"I1\" num_pins=\"" + str(N) + "\" equivalent=\"full\"/>\n")
	vpr_file.write("    <input name=\"I2\" num_pins=\"" + str(N) + "\" equivalent=\"full\"/>\n")
	vpr_file.write("    <input name=\"I3\" num_pins=\"" + str(N) + "\" equivalent=\"full\"/>\n")
	vpr_file.write("    <input name=\"I4\" num_pins=\"" + str(N) + "\" equivalent=\"full\"/>\n")
	vpr_file.write("    <output name=\"O1\" num_pins=\"2\" equivalent=\"full\"/>\n")
	vpr_file.write("    <output name=\"O2\" num_pins=\"2\" equivalent=\"full\"/>\n")
	vpr_file.write("    <output name=\"O3\" num_pins=\"2\" equivalent=\"full\"/>\n")
	vpr_file.write("    <output name=\"O4\" num_pins=\"2\" equivalent=\"full\"/>\n")
	vpr_file.write("    <output name=\"O5\" num_pins=\"2\" equivalent=\"full\"/>\n")
	vpr_file.write("    <output name=\"O6\" num_pins=\"2\" equivalent=\"full\"/>\n")
	vpr_file.write("    <output name=\"O7\" num_pins=\"2\" equivalent=\"full\"/>\n")
	vpr_file.write("    <output name=\"O8\" num_pins=\"2\" equivalent=\"full\"/>\n")
	vpr_file.write("    <output name=\"O9\" num_pins=\"2\" equivalent=\"full\"/>\n")
	vpr_file.write("    <output name=\"O10\" num_pins=\"2\" equivalent=\"full\"/>\n")
	...
	vpr_file.write("  <input name=\"in_A\" num_pins=\"1\" />\n")
	vpr_file.write("  <input name=\"in_B\" num_pins=\"1\" />\n")
	vpr_file.write("  <input name=\"in_C\" num_pins=\"1\" />\n")
	vpr_file.write("  <input name=\"in_D\" num_pins=\"1\" />\n")
	vpr_file.write("  <input name=\"in_E\" num_pins=\"1\" />\n")
	vpr_file.write("  <input name=\"in_F\" num_pins=\"1\" />\n")
	vpr_file.write("  <output name=\"out_local\" num_pins=\"1\" />\n")
	vpr_file.write("  <output name=\"out_routing\" num_pins=\"2\" />\n")
	vpr_file.write("  <clock name=\"clk\" num_pins=\"1\"/> \n")
	...
	vpr_file.write("    </interconnect>\n")
	vpr_file.write("    <fc in_type=\"frac\" in_val=\"" + str(Fcin) + "\" out_type=\"frac\" out_val=\"" + str(Fcout) + "\"/>\n")
...
def print_vpr_file_memory(vpr_file, fpga_inst):
	...
	vpr_file.write("  <!-- Basic logic element definition -->\n")
	vpr_file.write("  <pb_type name=\"ble6\" num_pb=\"" + str(N) + "\">\n")
	vpr_file.write("  <input name=\"in_A\" num_pins=\"1\" equivalent=\"none\"/>\n")
	vpr_file.write("  <input name=\"in_B\" num_pins=\"1\" equivalent=\"none\"/>\n")
	vpr_file.write("  <input name=\"in_C\" num_pins=\"1\" equivalent=\"none\"/>\n")
	vpr_file.write("  <input name=\"in_D\" num_pins=\"1\" equivalent=\"none\"/>\n")
	vpr_file.write("  <input name=\"in_E\" num_pins=\"1\" equivalent=\"none\"/>\n")
	vpr_file.write("  <input name=\"in_F\" num_pins=\"1\" equivalent=\"none\"/>\n")
	vpr_file.write("  <output name=\"out_local\" num_pins=\"1\" equivalent=\"none\"/>\n")
	vpr_file.write("  <output name=\"out_routing\" num_pins=\"2\" equivalent=\"full\"/>\n")
	vpr_file.write("  <clock name=\"clk\" num_pins=\"1\"/> \n")
	vpr_file.write("  <pb_type name=\"lut6\" blif_model=\".names\" num_pb=\"1\" class=\"lut\">\n")
	vpr_file.write("  <input name=\"in\" num_pins=\"" + str(K) + "\" port_class=\"lut_in\"/>\n")
	vpr_file.write("  <output name=\"out\" num_pins=\"1\" port_class=\"lut_out\"/>\n")
	...
	#vpr_file.write("    <fc in_type=\"abs\" in_val=\""+str(fpga_inst.cb_mux.required_size)+"\" out_type=\"abs\" out_val=\""+str(fpga_inst.sb_mux.required_size)+"\"/>\n")
	#vpr_file.write("    <pinlocations pattern=\"spread\"/>\n")
	vpr_file.write("    <fc in_type=\"frac\" in_val=\"0.15\" out_type=\"frac\" out_val=\"0.10\"/>\n")
	vpr_file.write("    <pinlocations pattern=\"spread\"/>\n")
	vpr_file.write("  </pb_type>\n")
...
def print_vpr_file_flut_hard(vpr_file, fpga_inst):
	...
	if independent_inputs > 0:
		vpr_file.write("  <input name=\"in_E2\" num_pins=\"1\" equivalent=\"none\"/>\n")	
	if independent_inputs > 1:
		vpr_file.write("  <input name=\"in_D2\" num_pins=\"1\" equivalent=\"none\"/>\n")	
	if independent_inputs > 2:
		vpr_file.write("  <input name=\"in_C2\" num_pins=\"1\" equivalent=\"none\"/>\n")	
	if independent_inputs > 3:
		vpr_file.write("  <input name=\"in_B2\" num_pins=\"1\" equivalent=\"none\"/>\n")	
	if independent_inputs > 4:
		vpr_file.write("  <input name=\"in_A2\" num_pins=\"1\" equivalent=\"none\"/>\n")		

	vpr_file.write("  <output name=\"out_local\" num_pins=\"2\" equivalent=\"none\"/>\n")
	vpr_file.write("  <output name=\"out_routing\" num_pins=\"2\" equivalent=\"full\"/>\n")
	vpr_file.write("  <clock name=\"clk\" num_pins=\"1\"/> \n")
	...
	vpr_file.write("  <input name=\"in_E\" num_pins=\"1\" equivalent=\"none\"/>\n")
	vpr_file.write("  <output name=\"out_local\" num_pins=\"1\" equivalent=\"none\"/>\n")
	vpr_file.write("  <output name=\"out_routing\" num_pins=\"1\" equivalent=\"full\"/>\n")
	vpr_file.write("  <clock name=\"clk\" num_pins=\"1\"/> \n")
...
def print_vpr_file(fpga_inst, arch_folder, enable_bram_module):
	...
	if enable_bram_module == 1:
		...
		print_vpr_file_ib(vpr_file, fpga_inst)
		#_flut_hard
	vpr_file.close()