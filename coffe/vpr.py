...
def print_vpr_file_updates(vpr_file, fpga_inst):
...
def print_vpr_file(fpga_inst, arch_folder, enable_bram_module, updates):

	vpr_file = open(os.path.join(arch_folder, "vpr.xml"), 'w')

	if enable_bram_module == 1:
		print_vpr_file_memory(vpr_file, fpga_inst)
        elif updates:
                print_vpr_file_updates(vpr_file, fpga_inst)
        else:
