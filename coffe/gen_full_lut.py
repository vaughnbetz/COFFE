...
def generate_full_lut(spice_file_name):
	...
	for i in range(1, 2**(lvl_curr-1)+1):
		#spice_file.write("Xinv_sram_driver_1_"+str(i)+" n_sram_"+ str(sram_cell_count) + " n_inter_" + str(sram_cell_count) + " n_vdd n_gnd inv Wn=45n Wp=75.015'\n")
		if (math.ceil(i%2)==0):
			spice_file.write("Xinv_sram_driver_1_"+str(i)+" vdd n_inter_" + str(sram_cell_count) + " n_vdd n_gnd inv Wn=45n Wp=75.015n\n")
		else:
			spice_file.write("Xinv_sram_driver_1_"+str(i)+" gnd n_inter_" + str(sram_cell_count) + " n_vdd n_gnd inv Wn=45n Wp=75.015n\n")	
		...
		spice_file.write("Xinv_sram_driver_2_"+str(i)+" n_inter_2_"+ str(sram_cell_count) + " n_inter_3_" + str(sram_cell_count) + " n_vdd n_gnd inv Wn=inv_lut_0sram_driver_2_nmos Wp=inv_lut_0sram_driver_2_pmos\n")
		...
		#spice_file.write("Xinv_sram_driver_1_"+str(i)+" n_sram_"+ str(sram_cell_count+1) + " n_inter_" + str(sram_cell_count+1) + " n_vdd n_gnd inv Wn=45n Wp=75.015'\n")
				#spice_file.write("Xinv_sram_driver_1_"+str(i)+" n_sram_"+ str(sram_cell_count) + " n_inter_" + str(sram_cell_count) + " n_vdd n_gnd inv Wn=45n Wp=75.015'\n")
		if (math.ceil(i%2)==0):
			spice_file.write("Xinv_sram_driver_1_2_"+str(i)+" vdd n_inter_" + str(sram_cell_count+1) + " n_vdd n_gnd inv Wn=45n Wp=75.015n\n")
		else:
			spice_file.write("Xinv_sram_driver_1_2_"+str(i)+" gnd n_inter_" + str(sram_cell_count+1) + " n_vdd n_gnd inv Wn=45n Wp=75.015n\n")
		...
		spice_file.write("Xinv_sram_driver_2_2_"+str(i)+" n_inter_2_"+ str(sram_cell_count+1) + " n_inter_3_" + str(sram_cell_count+1) + " n_vdd n_gnd inv Wn=inv_lut_0sram_driver_2_nmos Wp=inv_lut_0sram_driver_2_pmos\n")
